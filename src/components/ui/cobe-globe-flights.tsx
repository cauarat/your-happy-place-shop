...
// The ✈️ stickers are pinned to the arcs by CSS Anchor Positioning: cobe drops a
// 1px `anchor-name` div per arc, and the sticker below resolves `anchor(top)` /
...
// visibility custom property still resolves — which would leave all five planes
