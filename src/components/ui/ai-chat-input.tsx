  ...
  (
    ...
    const startRecording = useCallback(async () => {
      ...
      function simulateText() {
        const fakeText = "Procurando por bolsas e sapatos";
        ...
        >
          ...
          >
            ...
            {suggestion && value && suggestion.toLowerCase().startsWith(value.toLowerCase()) && (
              <div className="absolute left-[16px] top-[18px] pointer-events-none flex items-center text-[14px] leading-[22px] text-muted-foreground/50 whitespace-pre overflow-hidden z-[0]">
            ...
            <textarea
              ...
              className={cn(
                "prompt-scrollbar absolute top-0 inset-x-0 z-[1] w-full resize-none bg-transparent pl-4 pr-12 py-[17px] text-sm leading-[22px] text-foreground outline-none placeholder:font-medium placeholder:text-muted-foreground/80 cursor-text",
            ...
            <button
              ...
              className={cn(
                "absolute inset-x-0 top-0 z-[1] cursor-text pl-4 pr-12 py-[17px] text-left text-sm font-medium leading-[22px] text-muted-foreground/80 outline-none",
            ...
            <button
              ...
              className="absolute right-3 bottom-3 z-[10] flex h-8 w-8 items-center justify-center bg-primary text-primary-foreground transition-all duration-300 hover:opacity-90 outline-none focus-visible:ring-2 focus-visible:ring-ring cursor-default"
            >
