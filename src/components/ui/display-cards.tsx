...
function DisplayCard({
  ...
  iconWrapperClassName = "bg-blue-800",
  ...
  return (
    ...
    >
      <div>
        <span className={cn("relative inline-block rounded-full p-1", iconWrapperClassName, iconClassName)}>
          {icon}
        </span>
        <p className={cn("text-lg font-medium", titleClassName)}>{title}</p>
      </div>
      {description && <p className={cn("whitespace-nowrap text-lg", descriptionClassName)}>{description}</p>}
