      ...
      >
        <div className="flex flex-col items-center justify-center flex-1 w-full max-w-md mx-auto px-8">
          ...
          <motion.div
            ...
            className="mb-10"
          >
            <img src="/apple-touch-icon.png" alt="Villaoro" className="w-[88px] h-[88px] rounded-[22px] shadow-[0_8px_32px_rgba(0,0,0,0.08),0_2px_8px_rgba(0,0,0,0.04)] border border-black/5" />
          </motion.div>
