...
const translations: Record<Language, Record<string, string>> = {
  EN: {
    ...
    onboarding_quick_tour: "Take a quick tour",
  ...
  PT: {
    ...
    onboarding_quick_tour: "Fazer um tour rápido",
    onboarding_already_member: "Já sou um membro",
  ...
  ES: {
    ...
    onboarding_quick_tour: "Hacer un recorrido rápido",
