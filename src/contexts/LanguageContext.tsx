...
const translations: Record<Language, Record<string, string>> = {
  EN: {
    ...
    onboarding_style_desc: "How do you prefer your fit?",
    onboarding_male: "Male",
    onboarding_female: "Female",
    onboarding_both: "Both",
    onboarding_hunt_title: "The Hunt",
    onboarding_hunt_desc: "What are you looking for today? Select one.",
    onboarding_brand_title: "Brand Affinity",
    onboarding_brand_desc: "Which houses align with your taste? (Choose up to 3)",
    onboarding_email_title: "Enter your email address",
  ...
  PT: {
    ...
    onboarding_style_desc: "Como você prefere seu caimento?",
  ...
  ES: {
    ...
    onboarding_style_title: "Perfil de Estilo",
    onboarding_style_desc: "¿Cómo prefieres tu ajuste?",
    onboarding_male: "Masculino",
    onboarding_female: "Femenino",
    onboarding_both: "Ambos",
    onboarding_hunt_title: "La Búsqueda",
    onboarding_hunt_desc: "¿Qué estás buscando hoy? Selecciona uno.",
    onboarding_brand_title: "Afinidad de Marca",
    onboarding_brand_desc: "¿Qué casas se alinean con tu gusto? (Elige hasta 3)",
    onboarding_email_title: "Ingresa tu correo electrónico",
