...
const translations: Record<Language, Record<string, string>> = {
  EN: {
    ...
    install_step1_desc: "On Safari, tap Share. On Chrome, tap the three dots (⋮).",
  ...
  PT: {
    ...
    install_step1_desc: "No Safari, toque em Compartilhar. No Chrome, toque nos três pontos (⋮).",
  ...
  ES: {
    ...
    install_step1_desc: "En Safari, toca Compartir. En Chrome, toca los tres puntos (⋮).",
