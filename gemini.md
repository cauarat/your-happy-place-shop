...
6. **Autoplay de Música:** Sempre que o usuário entrar no site (seja pela home, onboarding ou catálogo), a música de fundo deve tentar iniciar automaticamente. Se o navegador bloquear, inicie na primeira interação (scroll, clique, etc).
